...
export function SubdivideItemDialog({ item, isOpen, onClose }: SubdivideItemDialogProps) {
    ...
    const [unit, setUnit] = useState('m') // Default to meters, should be dynamic based on category
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            try {
                const response = await fetch('/api/catalogo/transformations/subdivide', {
                    method: 'POST',
    ...
    // Calculate total to show validation
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            {/* Try to show relevant value from metadata */}
