            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[var(--color-background)]">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <p className="text-xs text-center text-[var(--color-muted-foreground)]">
                        Para desarrollo: Contraseña de usuarios seeded es <code className="px-1.5 py-0.5 bg-[var(--color-muted)] rounded text-[var(--color-foreground)] font-mono">12341234</code>
                    </p>
                </div>
            </div>
